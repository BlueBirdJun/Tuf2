...
public class TUFTenantInfo : ITenantInfo
{
    public TUFTenantInfo()
    {
    }

    public TUFTenantInfo(string id, string name, string? connectionString, string adminEmail, string? issuer = null)
    {
        Id = id;
        Identifier = id;
        Name = name;
