...
namespace TUF.Client.Client.Components.Notifications;
...
public partial class NotificationConnection : IDisposable, IAsyncDisposable
{
    ...
    {
        //var rrr = Config[ConfigName.ApiBaseUrl];
        ///var token =await TokenProvider.GetLocalToken();
        _hubConnection = new HubConnectionBuilder()
            .WithUrl($"{Config[ConfigName.ApiBaseUrl]}/notifications")
